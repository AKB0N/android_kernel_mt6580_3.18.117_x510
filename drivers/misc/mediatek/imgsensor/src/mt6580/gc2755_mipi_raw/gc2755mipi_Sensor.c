...
static kal_bool run_test_pattern=0;
static kal_uint32 set_test_pattern_mode(kal_bool enable);
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC2755_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h

    .checksum_value = 0xd700d28b,        //checksum value for Camera Auto Test
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x17, 0x15);//mirror/flip
	...
	////////////////////////////////////////////////////
	write_cmos_sensor(0x92, 0x03);
	write_cmos_sensor(0x94, 0x0b);//08
