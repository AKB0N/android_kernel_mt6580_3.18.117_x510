...
UINT32 DJ_OV8865_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
#endif
#if defined(DJ_OV8865_MIPI_RAW)
    {DJ_OV8865_SENSOR_ID, SENSOR_DRVNAME_DJ_OV8865_MIPI_RAW,DJ_OV8865_MIPI_RAW_SensorInit},
#endif
