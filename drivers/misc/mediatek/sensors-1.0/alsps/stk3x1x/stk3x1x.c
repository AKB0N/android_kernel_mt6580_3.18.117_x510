...
/*----------------------------------------------------------------------------*/
 ...
 #if defined(__HCT_PS_STK3X1X_DYNK_LOW_OFFSET__) &&(__HCT_PS_STK3X1X_DYNK_LOW_OFFSET__ >0)
	#define STK_LT_N_CT	__HCT_PS_STK3X1X_DYNK_LOW_OFFSET__
 #else
	#define STK_LT_N_CT	100
 #endif
 #if defined(__HCT_PS_STK3X1X_DYNK_HIGH_OFFSET__) &&(__HCT_PS_STK3X1X_DYNK_HIGH_OFFSET__ >0)
	#define STK_HT_N_CT	__HCT_PS_STK3X1X_DYNK_HIGH_OFFSET__
 #else
...
/*----------------------------------------------------------------------------*/
#ifdef STK_ALS_FIR
#if defined(__HCT_STK3X1X_FIR_LEN__)
	#define STK_FIR_LEN	__HCT_STK3X1X_FIR_LEN__
#else
...
static int ps_batch(int flag, int64_t samplingPeriodNs, int64_t maxBatchReportLatencyNs)
{
	...
	APS_LOG("stk3x1x ps setdelay = (%d) ok.\n", value);
	return 0;
}
